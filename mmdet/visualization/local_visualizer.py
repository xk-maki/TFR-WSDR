    ...
    def _draw_instances(self, image: np.ndarray, instances: ['InstanceData'],
        ...
        if 'bboxes' in instances and instances.bboxes.sum() > 0:
            ...
            for i, (pos, label) in enumerate(zip(positions, labels)):
                ...
                '''wxk修改'''
                text_colors_ground = colors[i]
                rgba = (text_colors_ground[0]/255.0, text_colors_ground[1]/255.0,text_colors_ground[2]/255.0, 1)
                # print(text_colors_ground[0],text_colors_ground[1],text_colors_ground[2])
